...
export default function DashboardPanel({ ros, robotName, robot }) {
  ...
  useEffect(() => {
    ...
    const odomListener = new window.window.ROSLIB.Topic({ ros: ros, name: '/hoverboard_base_controller/odom', messageType: 'nav_msgs/Odometry' });
  ...
  useEffect(() => {
    ...
    const batListener = new window.window.ROSLIB.Topic({ ros: ros, name: '/battery_state', messageType: 'sensor_msgs/BatteryState' });
  ...
  useEffect(() => {
    ...
    const modeListener = new window.window.ROSLIB.Topic({ ros: ros, name: '/robot/mode_str', messageType: 'std_msgs/String' });
  ...
  const cycleMode = (e) => {
    ...
    const service = new window.window.ROSLIB.Service({ ros: ros, name: '/robot/set_mode', serviceType: 'freebotics_msgs/SetMode' });
